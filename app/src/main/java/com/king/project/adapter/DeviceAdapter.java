package com.king.project.adapter;
...
public class DeviceAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ViewHolder holder;
        if(convertView!=null)
        {
            //convertView= LayoutInflater.from(context).inflate(R.layout.device_adapter,null);
            holder = (ViewHolder) convertView.getTag();
        }
        else
        {
            convertView = View.inflate(context, R.layout.device_adapter, null);
